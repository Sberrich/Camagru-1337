...
<h1 class="display-2"><?php echo $data['title']; ?></h1>
   <div>
       ...
       <div class="elementor-image">
         ...
         sizes="(max-width: 400px) 120vw, 400px" ><img width="400" height="500" ></div>
    </div> 
    <a href="<?php echo URLROOT;?>/users/login"><button type="button" class="btn btn-outline-success center-block">Log in</button></a>
</div>
