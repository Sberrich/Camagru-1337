        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <form action="<?php echo URLROOT ;?>/users/edit" method="post">
                    ...
                    <div class="row justify-content-center">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" name="notif" checked>
                            <label class="form-check-label" for="materialChecked2">Notification(Desactive)</label>
                        </div>
                    </div>
