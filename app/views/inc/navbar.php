<nav class="navbar navbar-expand-lg navbar-light"style="background-color: #A8ABAB;">
  <div class="container">
  <a class="navbar-brand" href="<?php echo URLROOT;?>/Posts/index"><i class="fa fa-comment"></i> <?php echo SITENAME; ?></a>
