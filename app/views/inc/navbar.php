  ...
  <div class="collapse navbar-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active pr-3">
        <a class="nav-link" href="<?php echo URLROOT;?>/Posts/index"><i class="fas fa-home" aria-hidden="true"></i> Home</a>
      </li>
      <li class="nav-item active pr-3">
        <a class="nav-link" href="<?php echo URLROOT;?>/pages/about"><i class="fa fa-info-circle" aria-hidden="true"></i>About </a>
      </li>
    </ul>
    ...
    <?php else: ?>
       <li class="nav-item active pr-3">
        <a class="nav-link" href="<?php echo URLROOT;?>/users/register"><i class="fa fa-registered" aria-hidden="true"></i>egister</a>
      </li>
      <li class="nav-item active pr-3">
        <a class="nav-link" href="<?php echo URLROOT;?>/users/login"><i class="fas fa-sign-in-alt" aria-hidden="true"></i> Login</a>
      </li>
        <?php endif;?>
    </ul>
    </div>
