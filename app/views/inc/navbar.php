          ...
          <ul class="navbar-nav ml-auto">
            <!-- Check IF the User Have A ssesion id or not -->
              <?php if(isset($_SESSION['id'])): ?>
                <!-- User have an id -->
                <li class="nav-item active pr-3">
                    <a class="nav-link" href="<?php echo URLROOT;?>/users/profile"><i class="fas fa-user" aria-hidden="true"></i> <?php echo $_SESSION['username'];?> </a>
                </li>
                <!-- User have an id -->
                <li class="nav-item active pr-3">
                ...
                <li class="nav-item active pr-3">
                    <a class="nav-link" href="<?php echo URLROOT;?>/users/modify"><i class="fas fa-new" aria-hidden="true"></i> EditProfile </a>
                </li>
                <li class="nav-item active pr-3">
